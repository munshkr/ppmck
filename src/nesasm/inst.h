...
struct t_opcode base_inst[57] = {
    {NULL, "ADC", class4,
     IMM | ZP | ZP_X | ZP_IND | ZP_IND_X | ZP_IND_Y | ABS | ABS_X | ABS_Y, 0x61,
     0},
    {NULL, "AND", class4,
     IMM | ZP | ZP_X | ZP_IND | ZP_IND_X | ZP_IND_Y | ABS | ABS_X | ABS_Y, 0x21,
     0},
    ...
    {NULL, "CMP", class4,
     IMM | ZP | ZP_X | ZP_IND | ZP_IND_X | ZP_IND_Y | ABS | ABS_X | ABS_Y, 0xC1,
     0},
    ...
    {NULL, "EOR", class4,
     IMM | ZP | ZP_X | ZP_IND | ZP_IND_X | ZP_IND_Y | ABS | ABS_X | ABS_Y, 0x41,
     0},
    ...
    {NULL, "LDA", class4,
     IMM | ZP | ZP_X | ZP_IND | ZP_IND_X | ZP_IND_Y | ABS | ABS_X | ABS_Y, 0xA1,
     0},
    ...
    {NULL, "ORA", class4,
     IMM | ZP | ZP_X | ZP_IND | ZP_IND_X | ZP_IND_Y | ABS | ABS_X | ABS_Y, 0x01,
     0},
    ...
    {NULL, "SBC", class4,
     IMM | ZP | ZP_X | ZP_IND | ZP_IND_X | ZP_IND_Y | ABS | ABS_X | ABS_Y, 0xE1,
     0},
    {NULL, "SEC", class1, 0, 0x38, 0},
    {NULL, "SED", class1, 0, 0xF8, 0},
    {NULL, "SEI", class1, 0, 0x78, 0},
    {NULL, "STA", class4,
     ZP | ZP_X | ZP_IND | ZP_IND_X | ZP_IND_Y | ABS | ABS_X | ABS_Y, 0x81, 0},
