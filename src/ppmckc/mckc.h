...
#define VRC7TRACK                                                          \
  (TRACK(BVRC7TRACK + 5) | TRACK(BVRC7TRACK + 4) | TRACK(BVRC7TRACK + 3) | \
   TRACK(BVRC7TRACK + 2) | TRACK(BVRC7TRACK + 1) | TRACK(BVRC7TRACK))
#define VRC6TRACK \
  (TRACK(BVRC6TRACK + 2) | TRACK(BVRC6TRACK + 1) | TRACK(BVRC6TRACK))
#define VRC6PLSTRACK (TRACK(BVRC6TRACK + 1) | TRACK(BVRC6TRACK))
#define VRC6SAWTRACK (TRACK(BVRC6TRACK + 2))
#define N106TRACK                                                          \
  (TRACK(BN106TRACK + 7) | TRACK(BN106TRACK + 6) | TRACK(BN106TRACK + 5) | \
   TRACK(BN106TRACK + 4) | TRACK(BN106TRACK + 3) | TRACK(BN106TRACK + 2) | \
   TRACK(BN106TRACK + 1) | TRACK(BN106TRACK))
#define FME7TRACK \
  (TRACK(BFME7TRACK + 2) | TRACK(BFME7TRACK + 1) | TRACK(BFME7TRACK))
...
typedef struct {
  ...
  double
      lcnt;  //トラックのループ点(Lコマンド)を0として、そこからの経過したカウント数(ただしLより前は0)
...
enum { EFTBL_END = 0xffff, EFTBL_LOOP = 0xfffe };
